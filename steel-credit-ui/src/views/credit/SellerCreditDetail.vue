    ...
    <div class="section-card overview-card">
      <div class="overview-top">
        ...
        <div class="overview-info">
          <h2>{{ detail.enterpriseName }} · 卖家信用详情</h2>
      ...
      <div class="data-source-row" v-if="detail.erpSourceCount != null">
        <el-tag size="small" type="info">ERP数据: {{ detail.erpSourceCount }}家买家</el-tag>
...
function renderRadar() {
  ...
  radarChart.setOption({
    radar: {
      ...
      shape: 'polygon',
      splitArea: { areaStyle: { color: ['#f0fdf4', '#dcfce7', '#bbf7d0', '#86efac'] } }
    },
    series: [{
      type: 'radar',
      data: [{
